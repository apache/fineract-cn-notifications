...
public class TestNotificationGateways extends SuiteTestEnvironment {
  ...
  public TestNotificationGateways() {
    super();
  }

  @Before
  public void prepTest() {
    userContext = tenantApplicationSecurityEnvironment.createAutoUserContext(TestNotificationGateways.TEST_USER);
